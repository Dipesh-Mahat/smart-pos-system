/**
 * Mobile Scanner Connection Manager
 * 
...
class MobileScannerConnection {
    constructor() {
        ...
        console.log('Mobile Scanner Connection Manager initialized');
    }
    ...
    updateDeviceHeartbeat(roomCode, deviceId) {
        ...
        if (device) {
            ...
            device.lastActivity = Date.now();
            console.log(`Heartbeat received from device ${deviceId} in room ${roomCode}`);
